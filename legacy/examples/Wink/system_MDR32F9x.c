...
/** @addtogroup __MDR32F9x_System_Private_Variables MDR32F9x System Private Variables
  * @{
  */
...
/** @} */ /* End of group __MDR32F9x_System_Private_Variables */

/** @addtogroup __MDR32F9x_System_Private_Functions MDR32F9x System Private Functions
  * @{
  */
...
void SystemCoreClockUpdate (void)
{
  ...
  if ((MDR_RST_CLK->CPU_CLOCK & (uint32_t)0x00000004) == (uint32_t)0x00000004)
  {
    ...
    pll_mul = ((MDR_RST_CLK->PLL_CONTROL >> 4) & (uint32_t)0x0F) + 1;
    cpu_c2_freq *= pll_mul;
  }
...
/** @} */ /* End of group MDR32F9x_System_Private_Functions */

/** @} */ /* End of group MDR32F9x */

/** @} */ /* End of group Milandr */

/******************* (C) COPYRIGHT 2011 Phyton *********************************
*
* END OF FILE system_MDR32F9x.c */
